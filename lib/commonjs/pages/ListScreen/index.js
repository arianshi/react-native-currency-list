...
var _index = require("../../components/SearchBar/index");
...
function CurrencyList() {
  ...
  const filtered = (0, _useCurrencySearch.useCurrencySearch)(data, search);
  ...
  }, 'List Cryptocurrency'))), /*#__PURE__*/_react.default.createElement(_index.SearchBar, {
    value: search,
    onChangeText: setSearch,
    handleClear: handleClear
  }), filtered.length === 0 ? /*#__PURE__*/_react.default.createElement(_EmptyState.EmptyState, null) : /*#__PURE__*/_react.default.createElement(_reactNative.FlatList, {
    data: filtered,
