...
var _NavigationService = _interopRequireDefault(require("./NavigationService"));
...
const CurrencyListNavContainer = () => {
  return /*#__PURE__*/_react.default.createElement(_core.NavigationIndependentTree, null, /*#__PURE__*/_react.default.createElement(_native.NavigationContainer, {
    ref: navigatorRef => {
      _NavigationService.default.setTopLevelNavigator(navigatorRef);
    }
  }, /*#__PURE__*/_react.default.createElement(_Screen.default, null, /*#__PURE__*/_react.default.createElement(ListStack, null))));
};
